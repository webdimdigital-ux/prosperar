...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Glazey proportions matching Input: h-11 default, h-8 sm
        "text-[#2E3A59] [&_svg:not([class*='text-'])]:text-[#B0BBCF]",
        "flex w-full items-center justify-between gap-2 rounded-xl border border-[#E8ECF4] bg-[#FAFBFD] px-4 text-sm whitespace-nowrap font-[Poppins,sans-serif]",
